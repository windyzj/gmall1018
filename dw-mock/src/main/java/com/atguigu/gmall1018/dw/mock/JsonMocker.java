...
import com.atguigu.gmall1018.dw.util.RanOpt;
import com.atguigu.gmall1018.dw.util.RandomDate;
import com.atguigu.gmall1018.dw.util.RandomNum;
import com.atguigu.gmall1018.dw.util.RandomOptionGroup;
...
public class JsonMocker {
    ...
    String initStartupLog() {
     ...
     `area` string COMMENT '城市' */
        String mid = "mid_" + RandomNum.getRandInt(1, 3200);
